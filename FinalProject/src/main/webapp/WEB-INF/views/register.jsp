...
<body>
	...
	<form:form action="register.htm" data-toggle="validator" commandName="user" method="POST">
		<table>
			<tr>
				<td>First Name:</td>
				<td><form:input path="firstName" size="30" pattern="^[_A-z]{1,}$" required="required" />
					<font color="red"><form:errors path="firstName" /></font></td>
			</tr>

			<tr>
				<td>Last Name:</td>
				<td><form:input path="lastName" size="30" pattern="^[_A-z]{1,}$" required="required" />
			...
			<tr>
				<td>Password:</td>
				<td><form:password path="password" size="30" pattern="^[_@.A-z0-9]{1,}$"
